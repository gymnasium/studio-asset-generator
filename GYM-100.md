...
<p>
<a href="https://gymnasium.github.io{{ page.course }}/Lesson_Files/{{ page.zip }}">Download a zip file of all student assets</a>
</p>
<dl>{% for lesson in page.lessons %}
  <div>
    <dt>{{ lesson.title }}</dt>
    <dd>
      <a href="https://gymnasium.github.io/{{ page.course_ID}}/Lesson_Files/{{ lesson.handout }}" target="_blank" rel="noopener">Handout</a>
    </dd>{% if lesson.files %}
    <dd>
      <a href="https://gymnasium.github.io/{{ page.course_ID}}/Lesson_Files/{{ lesson.files }}">Homework Files</a>
    </dd>{% endif %}
  </div>{% endfor %}
</dl>
```
...
<article id="homework-materials">
  ...
  <ul>
    ...
    <li>
      <a href="https://gymnasium.github.io/{{ page.course_ID}}/Lesson_Files/{{ lesson.files }}">Homework Files (ZIP)</a>
    </li>{% endif %}
  </ul>
</article>
```
